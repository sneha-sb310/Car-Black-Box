...
void main(void) {
    ...
    while (1) {
        ...
        if (key == 0x3E) {
            ...
            strcpy(event, gear[gr]);
            log_event(event, speed);
        } else if ((key == 0x37 || key == 0x2F) && screen_flag == 0x01) {
            screen_flag = 0x03;
            reset_flag = 0x12;
            clear_screen();
        ...
        if ((key == 0XB7 || key == 0x1F) && (screen_flag == 0x02)) {
        ...
        } else if ((key == 0XB7 || key == 0x1F) && (screen_flag == 0x04)) {
            screen_flag = 0x02;
            reset_flag = 0x13;
            clcd_write(0x0C, 0);
        } else if ((key == 0XB7 || key == 0x1F) && screen_flag == 0x08) {
            clcd_write(0x0C, 0);
            ...
            write_ds1307(0x00, (newSec / 10 << 4) | (newSec % 10));
            write_ds1307(0x01, (newMin / 10 << 4) | (newMin % 10));
            write_ds1307(0x02, (newHr / 10 << 4) | (newHr % 10));
        }
        else if ((key == 0xAF) && (screen_flag == 0x04 || screen_flag == 0x08)) {
            screen_flag = 0x01;
            clear_screen();
            clcd_write(0x0C, 0);
        }
